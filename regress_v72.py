...
def valid_brief():
    ...
    body = ("미국장 마감 시점 기준으로 시장의 선택은 일부 업종에 집중된 모습이었습니다. "
            ...
            "지수는 크게 흔들리지 않았지만 업종별로는 방향이 뚜렷하게 갈렸습니다. "
    ...
    vcr = ("산업 계열 안을 들여다보면 강약 차이가 뚜렷했습니다. 반도체 계열에서는 반도체 "
           "본체가 앞섰고 반도체장비가 뒤를 이었습니다. 같은 우산 아래에서도 앞선 축과 "
           "뒤처진 축이 갈렸습니다. 개별 종목 단위에서도 결과가 나뉘었는데 AMD는 자기 업종과 "
           "시장을 모두 앞선 쪽에 놓였습니다. 같은 산업에 속해 있어도 종목별로 결과가 "
           "갈렸다는 뜻입니다.")
