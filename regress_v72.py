...
def valid_brief():
    ...
    nxt = ("다음 거래일에는 상위 흐름이 이어지는지 확인할 수 있습니다. 금융과 필수소비의 "
           ...
           "살피는 것이 관건입니다. 두 시간 축이 다시 정렬되는지도 눈여겨볼 지점입니다. "
           "해석을 유지할 조건과 무효화할 조건을 나란히 두고 봅니다.")
    return {
        ...
        "sections": [
            ...
            {"id": "breadth", "title": "시장 체력과 스타일",
             "body": "신고가 종목이 신저가보다 많았고 상승 거래량이 하락 거래량을 앞섰습니다. "
                     ...
                     "점을 확인할 수 있습니다. 신고가와 신저가의 격차가 뚜렷했던 만큼 시장의 "
                     "저변이 크게 약해졌다고 보기는 어려운 구성이었습니다. 다만 상승의 폭이 "
                     "고르게 퍼졌는지는 별도로 살펴야 합니다. 시장 체력 자체는 유지된 하루였습니다.",
             "tickers": [], "themes": []},
